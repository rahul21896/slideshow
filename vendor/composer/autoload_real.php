...
class ComposerAutoloaderInit077229b15377be21c36fa763b1d3ea41 {
	...
	public static function getLoader() {
		...
		if ( $useStaticLoader ) {
			$includeFiles = Composer\Autoload\ComposerStaticInit077229b15377be21c36fa763b1d3ea41::$files;
		} else {
			$includeFiles = require __DIR__ . '/autoload_files.php';
		}
		foreach ( $includeFiles as $fileIdentifier => $file ) {
			composerRequire077229b15377be21c36fa763b1d3ea41( $fileIdentifier, $file );
		}
...
function composerRequire077229b15377be21c36fa763b1d3ea41( $fileIdentifier, $file ) {
